...
part of 'account_hibernate_reset_cubit.dart';
...
/// @nodoc
mixin _$AccountHibernateResetState {
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountHibernateResetState);
}
...
@override
String toString() {
  return 'AccountHibernateResetState()';
}
...
/// @nodoc
class $AccountHibernateResetStateCopyWith<$Res>  {
$AccountHibernateResetStateCopyWith(AccountHibernateResetState _, $Res Function(AccountHibernateResetState) __);
}


/// Adds pattern-matching-related methods to [AccountHibernateResetState].
extension AccountHibernateResetStatePatterns on AccountHibernateResetState {
...
class _Idle implements AccountHibernateResetState {
  const _Idle();
...
@override
String toString() {
  return 'AccountHibernateResetState.idle()';
}
...
class _Submitting implements AccountHibernateResetState {
  const _Submitting();
...
@override
String toString() {
  return 'AccountHibernateResetState.submitting()';
}
...
class _Success implements AccountHibernateResetState {
  const _Success(this.message);
  

 final  String message;

/// Create a copy of AccountHibernateResetState
...
@override
String toString() {
  return 'AccountHibernateResetState.success(message: $message)';
}
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $AccountHibernateResetStateCopyWith<$Res> {
...
class _Error implements AccountHibernateResetState {
...
@override
String toString() {
  return 'AccountHibernateResetState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $AccountHibernateResetStateCopyWith<$Res> {
