...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    ...
    AutoRoute(page: MarkerWithoutPostRoute.page),
    AutoRoute(page: MarkerPostsRoute.page),
    ...
    AutoRoute(page: PersonalizationRoute.page),
    ...
    AutoRoute(page: PartnerRoute.page),
