-- Fix remote function list_markers_map after renaming markers.title -> address_text.
-- Some environments may still have an older function body referencing m.title.
